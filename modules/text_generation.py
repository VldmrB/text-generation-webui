...
def find_stopping_newline(reply: str,
    ...
    #      reply, reply_len, newlines_found, stop_found
...
def _generate_reply(question, state, stopping_strings=None, is_chat=False):
    ...
    # if newlines_allowed and newlines_found != total_newlines + 1 and newlines_found > newlines_found:
    #     print('Wrong newline matching!')
    # print(f'{newlines_allowed=} {newlines_found=} {total_newlines=}')
    yield reply
